...
def search_query(user_id, start_time, end_time, page_num, page_size):
    search_query_msg = {'user_id': user_id, 'start_time': start_time, 
        'end_time': end_time, 'page_num':page_num, 'page_size':page_size}
    rsp = requests.request('POST', 'http://172.18.0.4:1234/Searcher', 
...
if __name__ == '__main__':
    search_query(sys.argv[1], sys.argv[2] + ' ' + sys.argv[3],
