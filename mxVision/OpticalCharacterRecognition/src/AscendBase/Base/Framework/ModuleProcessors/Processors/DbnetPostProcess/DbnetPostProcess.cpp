...
APP_ERROR DbnetPostProcess::Init(ConfigParser &configParser, ModuleInitParams &initParams)
{
    ...
    bool isClassification = Utils::EndsWith(initParams.pipelineName, "true");
    if (isClassification) {
...
APP_ERROR DbnetPostProcess::Process(std::shared_ptr<void> commonData)
{
    ...
    TextDetectionPost TextDetectionPost;
    TextDetectionPost.CharacterDetectionOutput(data->outputTensorVec, textObjInfos, resizedImageInfos);
