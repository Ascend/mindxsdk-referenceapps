...
CharacterRecognitionPost::CharacterRecognitionPost(void) {}
...
void CharacterRecognitionPost::InitClassName(const std::string &fileName)
{
...
std::string CharacterRecognitionPost::GetClassName(const size_t classId)
{
...
void CharacterRecognitionPost::CalcOutputIndex(void *resHostBuf, size_t batchSize, size_t objectNum, std::vector<std::string> &resVec)
{
