...
#ifndef CHARACTERRECOGNITIONPOST_H
#define CHARACTERRECOGNITIONPOST_H
...
class CharacterRecognitionPost {
public:
    CharacterRecognitionPost(void);
    
    ~CharacterRecognitionPost() {};

    void InitClassName(const std::string &fileName);
