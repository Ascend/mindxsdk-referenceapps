...
APP_ERROR ResnetDetector::Detect(const MxBase::DvppDataInfo &imageInfo, std::vector<std::vector<MxBase::ClassInfo>> &objInfos,
...
APP_ERROR ResnetDetector::TransformImageToTensor(const MxBase::DvppDataInfo &imageInfo, MxBase::TensorBase &tensor) const
{
...
APP_ERROR ResnetDetector::Inference(const std::vector<MxBase::TensorBase> &inputs, std::vector<MxBase::TensorBase> &outputs)
{
    APP_ERROR ret;
...
APP_ERROR ResnetDetector::LoadPostProcessConfig(const ResnetInitParam &initParam, std::map<std::string, std::shared_ptr<void>> &config)
{
