...
atc --model="${Home}"/Models/xxx.onnx --framework=5 --output="${Home}"/Models/helmet_head_person_s_1.7.0_op11_dbs_sim_t  --insert_op_conf=./aipp_YOLOv5.config --input_format=NCHW --log=info --soc_version=Ascend310 --input_shape="images:1,3,640,640" 
# --model为onnx所在路径