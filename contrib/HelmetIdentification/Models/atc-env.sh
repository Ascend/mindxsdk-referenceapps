...
export Home=${path}
# Home is set to the path where the onnx file is located

# Execute, transform YOLOv5 model.
atc --model="${Home}"/YOLOv5.onnx --framework=5 --output="${Home}"/YOLOv5.om  --insert_op_conf=./aipp_YOLOv5.config --input_format=NCHW --log=info --soc_version=Ascend310 --input_shape="images:1,3,640,640" 
