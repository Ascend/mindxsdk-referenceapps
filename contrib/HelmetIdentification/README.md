...
<img src="https://gitee.com/liu-kai6334/mindxsdk-referenceapps/raw/master/contrib/HelmetIdentification/image/image4.jpg" alt="image4" style="zoom:5;" />
...
| 2    | 输入视频中无可识别对象 | 打印Object detection  result of model infer is null!!!   |
| 3    | 输入视频有识别对象     | 打印每次推理的帧信息的尺寸与识别结果                     |
| 4    | 识别对象未佩戴安全帽   | 打印Warning:Not  wearing a helmet, InferenceId：FrameId: |
...
若pipline中拉取视频流，rstp地址异常或未添加264视频，则会导致程序堵塞，无法正常退出。
