...
/**
* @api
* @brief Definition of MxpiCollisionClassName class.
*/
namespace MxPlugins {
class MxpiCollisionClassName : public MxTools::MxPluginBase {
public:
    /**
     * @api
     ...
     * @return APP_ERROR
     */
    APP_ERROR CollisionJudgment(const MxTools::MxpiObjectList srcMxpiObjectList, MxTools::MxpiObjectList& dstMxpiObjectList);
private:
