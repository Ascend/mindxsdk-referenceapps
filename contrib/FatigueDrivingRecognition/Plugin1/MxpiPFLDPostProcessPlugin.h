...
#ifndef SDKMEMORY_MXPIPFLDPOSTPROCESSPLUGIN_H
#define SDKMEMORY_MXPIPFLDPOSTPROCESSPLUGIN_H
...
*/
namespace MxPlugins {
class MxpiPFLDPostProcessPlugin : public MxTools::MxPluginBase {
public:
    /**
     * @api
    ...
    /**
     * @api
     * @brief Get the MAR(Mouth Aspect Ratio) of person from model inference.
     * @param key
     * @param buffer
     * @return APP_ERROR
     */
    APP_ERROR GenerateObjectList(const MxTools::MxpiTensorPackageList srcMxpiTensorPackage,
