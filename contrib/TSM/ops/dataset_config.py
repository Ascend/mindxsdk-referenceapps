...
ROOT_DATASET = '/home/hailiang2/TSM/data/'
...
def return_kinetics(modality):
    ...
    if modality == 'RGB':
        ...
        filename_imglist_train = '/home/hailiang2/TSM/data/label/train_videofolder.txt'
        filename_imglist_val = '/home/hailiang2/TSM/data/label/val_videofolder.txt'
        prefix = 'img_{:05d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
