...
```
### 1.5 技术实现流程图
   ![本项目实现自然场景下的情绪识别，首先利用人脸检测模型采集图片中的人脸图像，然后利用情绪识别模型推理情绪类别。整体流程如下图所示。](https://gitee.com/wrt221/mindxsdk-referenceapps/blob/master/contrib/FacialExpressionRecognition/image/FER.png)
## 2 环境依赖
