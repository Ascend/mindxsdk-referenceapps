...
**步骤6** 精度验证。将bbox_root_mupots_output.json放在项目的eval目录下，请注意bbox_root_mupots_output.json中的测试数据的顺序，使用MuPoTS-3D.json作为金标准。进行精度验证，执行命令：
