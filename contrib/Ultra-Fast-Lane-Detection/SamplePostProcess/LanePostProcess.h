...
namespace MxBase {
    ...
    public:
        ...
        LanePostProcess &operator=(const LanePostProcess &other);
    ...
    protected:
        ...
        int biasesNum_ = DEFAULT_BIASES_NUM; // Lane anchors, generate from train data, coco dataset
