...
#ifndef SDKMEMORY_MXPITRACKRETROGRADECAR_H
#define SDKMEMORY_MXPITRACKRETROGRADECAR_H
...
namespace MxPlugins {
class MxpiTrackRetrogradeCar : public MxTools::MxPluginBase {
public:
    /**
     * @api
...
#endif // SDKMEMORY_MXPITRACKRETROGRADECAR_H
