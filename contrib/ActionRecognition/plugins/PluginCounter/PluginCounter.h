...
*/
#ifndef SDKMEMORY_PLUGINCOUNTER_H
#define SDKMEMORY_PLUGINCOUNTER_H
...
/**
* @api
* @brief Definition of PluginCounter class.
*/

namespace MxPlugins {
    class PluginCounter : public MxTools::MxPluginBase {
    public:
        /**
        * @api
...
#endif // SDKMEMORY_PLUGINCOUNTER_H