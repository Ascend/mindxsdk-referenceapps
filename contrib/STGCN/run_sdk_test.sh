...
export MX_SDK_HOME=/home/liukai2/MindX_SDK/mxVision-2.0.4
...
export PYTHONPATH=$PYTHONPATH:${MX_SDK_HOME}/python:/opt/anaconda3/envs/py392/bin/python3.9

python3.9 main.py $image_path $result_dir $n_pred
exit 0
