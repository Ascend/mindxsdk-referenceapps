...
def inference(
    ...
    y_bboxes = decode_bbox(anchors_exp, y_bboxes_output,variances=[0.1, 0.1, 0.2, 0.2])[0]
...
if __name__ == "__main__":
    ...
    # generate anchors
    anchors = generate_anchors(feature_map_sizes, anchor_sizes, anchor_ratios, offset=0.5)
