...
namespace MxBase {
    ...
    void Yolov3PostProcess::my_softmax(int x,int y)
    {
        float sum = 0.0;
        for (int i = 0; i < 200; ++i){
            sum += exp(out_k[i][x][y]);
...
//              out=featLayerData[0]
            ...
            float out[201][18][4];
            float out_j1[201][18][4];
            float out_m[200][18][4];
            float loc[18][4];
            float out_j2[18][4];
            float out_j3[18][4];
            //std::cout <<"--------------padbegindata[201][18][4]--" << std::endl;
            for (int i = 0; i < 201; ++i) {
            //std::cout <<"*******-" << std::endl;
                for(int j = 0; j < 18; ++j){
                    for(int k =0; k < 4; ++k){
...
//                        if(i==1)
//                        {
//                            std::cout << out_j1[i][j][k] << std::endl;
//                        }
                      }
            std::cout <<"--------------out_j1--over--" << std::endl;
            for(int i=0;i<200;i++)
                for(int j=0;j<18;j++)
                     for(int k=0;k<4;k++){
...
//                        if(i==199)
//                        {
//                            std::cout << out_k[i][j][k] << std::endl;
//                        }
                     }

            std::cout <<"--------------out_k--over--" << std::endl;

            for(int j=0;j<18;j++)
                for(int k=0;k<4;k++){
                    my_softmax(j,k);
                    //std::cout << prob[0][0][k] << std::endl;

                }


            std::cout <<"--------------prob--over--" << std::endl;
...
//                        if(i==199)
//                        {
//                            std::cout << out_m[i][0][0] << std::endl;
//                        }
                     }

            std::cout <<"--------------out_m--over--" << std::endl;
...
//             std::cout << loc[0][0] << std::endl;

            std::cout <<"--------------loc--over--" << std::endl;
