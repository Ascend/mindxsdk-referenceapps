...
#ifndef STREAM_PULL_SAMPLE_MOTCONNECTION_H
#define STREAM_PULL_SAMPLE_MOTCONNECTION_H
...
class MOTConnection {
public:
    APP_ERROR ProcessSort(std::vector<std::vector<MxBase::ObjectInfo>> &objInfos);
...
private:
    ...
    void FilterLowThreshold(const g_hungarianhandle &hungarianHandleObj, const std::vector<std::vector<int>> &disMatrix,
