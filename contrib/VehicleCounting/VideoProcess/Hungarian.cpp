...
static void HungarianInit(g_hungarianhandle &handle, const std::vector<std::vector<int>> &cost, int rows, int cols)
{
    int i, j, value;
    if (rows > cols) {
...
static bool Match(g_hungarianhandle &handle, int id)
{
    int j, delta;
